...
def upsert_gene_neuro_annotation(data: dict) -> None:
    ...
    INSERT INTO gene_neuro_annotation (
        ...
        go_toxic_response, ctd_chemicals, ctd_neuro_diseases, neuro_plausibility_score
    ) VALUES (
        ...
        %(go_toxic_response)s, %(ctd_chemicals)s, %(ctd_neuro_diseases)s, %(neuro_plausibility_score)s
    )
